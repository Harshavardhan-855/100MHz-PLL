...
C {devices/vsource.sym} -150 -600 0 0 {name=V2 value="pulse(0 1.8 0 1n  1n  10n 20n )" savecurrent=false
spice_ignore=true}
...
C {sky130_stdcells/dfxbp_2.sym} 190 -970 0 0 {name=x4 VGND=VSS VNB=VSS VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
