...
B 2 1950 -1340 2750 -940 {flags=graph
y1=0
y2=0.01
ypos1=0
ypos2=2
...
lab=out1}
N 1440 -1560 1440 -1530 { lab=vctrl1}
...
"
spice_ignore=false}
C {devices/code_shown.sym} 160 -1560 0 0 {name=STIMULI1
only_toplevel=true
value="
.op
.options acct list
...
C {devices/vsource.sym} 1440 -1500 0 0 {name=V4 value=vctrl1 net_name=true}
C {devices/gnd.sym} 1440 -1470 0 0 {name=l5 lab=GND}
C {devices/lab_wire.sym} 1440 -1560 1 0 {name=p10 sig_type=std_logic lab=vctrl1}
