...
S {}
E {}
B 2 12630 -10750 13430 -10350 {flags=graph
y1=0
y2=2
ypos1=0
ypos2=2
...
rainbow=1
digital=1}
B 2 12630 -10320 13430 -9920 {flags=graph
y1=-0.00032
y2=1.5
ypos1=0
ypos2=2
...
rainbow=1
digital=0}
B 2 12630 -9880 13430 -9480 {flags=graph
y1=-0.015
y2=1.9
ypos1=0
ypos2=2
...
lab=QA_B}
N 11920 -10500 12080 -10500 {
lab=cp_out}
N 11820 -10620 12170 -10620 {
lab=VDD}
N 12170 -10620 12170 -10560 {
lab=VDD}
N 11810 -10380 12170 -10380 {
lab=GND}
N 12170 -10440 12170 -10380 {
lab=GND}
N 12310 -10500 12310 -10490 {
lab=vco_out}
N 12260 -10500 12310 -10500 {
lab=vco_out}
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/pfd_cp_vco.raw tran"
}
...
C {vco/vco.sym} 12180 -10500 0 0 {name=x4}
C {devices/capa-2.sym} 12320 -10320 0 0 {name=C1
m=1
value=cload
footprint=1206
device=polarized_capacitor
spice_ignore=true}
C {devices/gnd.sym} 12320 -10290 0 0 {name=l2 lab=GND
spice_ignore=true}
C {devices/lab_wire.sym} 12280 -10500 1 0 {name=p11 sig_type=std_logic lab=vco_out}
